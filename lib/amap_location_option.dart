...
class AMapLocationOption {
  ...
  ///定位超时时间<br>
  ///单位：秒<br>
  ///默认值：10秒, 最低2s(android 建议超时时间不要低于8秒)<br>
  int locationTimeout = 10;

  ///iOS逆地理请求超时时间<br>
  ///单位：秒<br>
  ///默认值：10秒,最低2s<br>
  int reGeocodeTimeout = 10;
  ...
  Map getOptionsMap() {
    return {
      ...
      "locationTimeout": this.locationTimeout,
      "reGeocodeTimeout": this.reGeocodeTimeout,
