...
- (void)setLocationOption:(FlutterMethodCall*)call
{
    ...
    if (locationTimeout) {
        //   定位超时时间，最低2s
        [manager setLocationTimeout:[locationTimeout integerValue]];
    }
    ...
    if (needAddress) {
        ...
        //   逆地理请求超时时间，最低2s
        NSNumber *reGeocodeTimeout = call.arguments[@"reGeocodeTimeout"];
        [manager setReGeocodeTimeout:[reGeocodeTimeout integerValue]];
    }
