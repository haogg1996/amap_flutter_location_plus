...
public class AMapLocationClientImpl implements AMapLocationListener {
    ...
    public void setLocationOption(Map optionMap) {
        ...
        if (optionMap.containsKey("locationTimeout")) {
            // 高德定位的超时时间是毫秒，flutter端传递的是秒，所以这里需要乘以1000
            locationOption.setHttpTimeOut(((Integer) optionMap.get("locationTimeout")).longValue() * 1000);
        }
